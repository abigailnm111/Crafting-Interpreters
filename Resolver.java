...
class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    // resolves the single expression in an expression statement.
    @Override
    ...
    // binds the function names and starts a new scope. Defines the function name
    // before resolving the body to allow recursion.
    @Override
    ...
    public Void visitThisExpr(Expr.This expr){
        if(currentClass== ClassType.NONE){
            Lox.error(expr.keyword, "Can's use 'this' outside of a class.");
        }
